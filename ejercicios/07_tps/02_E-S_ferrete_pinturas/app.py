...
class App(customtkinter.CTk):
    ...
    def btn_convertir_c_f_on_click(self):
        ...
        temperatura_f = (0 - 32)* 5/9
        convertir_f_c = temperatura_f + temperatura_c
        alert("LA TEMPERATURA ES", convertir_f_c)
    ...
    def btn_convertir_f_c_on_click(self):
        ...
        temperatura_f = self.txt_temperatura_f.get()
        temperatura_f = (0 - 32)* 5/9
        convertir_c_f = temperatura_c + temperatura_f
        alert("LA TEMPERATURA ES", convertir_c_f)
